...
func TestCapabilitiesForModel(t *testing.T) {
	tests := []struct {
		...
		{name: "anthropic/claude-opus-4.7", wantWindow: contextWindowClaude200K, wantOutput: 128_000},
		...
		{name: "anthropic/claude-sonnet-4.6", wantWindow: contextWindowClaude200K, wantOutput: 64_000},
