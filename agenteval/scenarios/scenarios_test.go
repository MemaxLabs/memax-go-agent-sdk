...
func TestScenariosPass(t *testing.T) {
	...
	if !report.Passed() || len(report.Results) != 95 {
		t.Fatalf("report = %#v, want ninety-five passing scenarios", report)
	}
}
...
func TestScenarioNamesAreStable(t *testing.T) {
	...
	want := []string{
		...
		"personal_preset_personal_assistant_inbox_triage_reply_followup",
		"personal_preset_personal_assistant_inbox_send_backend_failure",
		"personal_preset_personal_assistant_jmap_inbox_reply",
		...
		"personal_preset_personal_assistant_week_ahead_planning",
		...
		"personal_preset_personal_assistant_scheduled_run_stale_reconciliation",
		"personal_preset_personal_assistant_scheduled_task_ledger_maintenance",
		...
		"cloudmanaged_preset_managed_worker_durable_run_lifecycle",
		"cloudmanaged_preset_managed_worker_execute_queued_run",
		"cloudmanaged_preset_managed_worker_remote_http_poll",
		"cloudmanaged_preset_managed_worker_remote_http_stale_failure",
		"cloudmanaged_preset_managed_worker_tenant_revocation",
		...
		"coding_preset_interactive_dev_wait_repair",
		"coding_preset_interactive_dev_wait_cursor_repair",
		...
		"command_session_wait_repair_loop",
