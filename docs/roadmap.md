...
- Add agent policy presets. Initial `toolkit/agentpolicy` hook preset exists
  ...
  after failed verification, plus verify-before-final gating after workspace
  mutations, without hard-coding policy into the core loop.
