...
- Add agent policy presets. Initial `toolkit/agentpolicy` hook preset exists
  for checkpoint-before-patch recovery without hard-coding policy into the core
  loop.
