...
func TestRunExampleShowsProactiveBriefingWorkflow(t *testing.T) {
	...
	for _, want := range []string{
		...
		"scheduled lifecycle: daily-brief:2026-04-19T07:00:00Z queued",
		"scheduled lifecycle: daily-brief:2026-04-19T07:00:00Z running",
		"scheduled lifecycle: daily-brief:2026-04-19T07:00:00Z succeeded",
